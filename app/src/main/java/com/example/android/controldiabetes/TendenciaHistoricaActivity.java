...
public class TendenciaHistoricaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         *
         * Renderer (It controls how the view is drawn,
                     settings some parameters you can change the way the charts looks like.
                     There are two types of renderer: one that controls the rendering of the dataset and
                     another one that controls how the main chart aspects look like (i.e. axis, labels and so on)
         * Chart factory (combines the dataset and the renderers to create the charts.
         The chart can be created inside an Activity or the factory can return a View.)
         * */
    ...
    private void openChart() {
        ...
        mChart = ChartFactory.getLineChartView(TendenciaHistoricaActivity.this, dataset, multiRenderer);
